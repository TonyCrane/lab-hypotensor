(() => {
  ...
  const preferToggle = e => {
    ...
    var theme = document.querySelector("body").getAttribute("data-md-color-scheme") === "slate" ? "https://gcore.jsdelivr.net/gh/TonyCrane/lab-hypotensor/docs/css/giscus.css" : "light"
...
window.toggleScheme = () => {
  ...
  var frame = document.querySelector(".giscus-frame")
  var theme = scheme === "slate" ? "https://gcore.jsdelivr.net/gh/TonyCrane/lab-hypotensor/docs/css/giscus.css" : "light"
  frame.contentWindow.postMessage(
    { giscus: { setConfig: { theme } } },
    "https://giscus.app"
  )
